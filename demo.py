...
def main():
    ...
    parser.add_argument(
        "--config-file",
        default="configs/efficient_net_b3_ssd300_voc0712.yaml",
        metavar="FILE",
    ...
    parser.add_argument("--images_dir", default='demo/test_trash', type=str, help='Specify a image dir to do prediction.')
